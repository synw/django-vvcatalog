...
class Query(graphene.AbstractType):
    root_categories = DjangoFilterConnectionField(CategoryNode)
    ...
    def resolve_root_categories(self, args, context, info):
        return Category.objects.filter(status="published", level=0).prefetch_related("children")
