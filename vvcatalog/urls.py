...
from vvcatalog.views import IndexView, categoryIndexView, categoryView, productsInCatView, productDetailView, \
isAuthenticated, SetCart, PostOrderView, CustomerUpdateFormView, CustomerFormView
from vv.views import IndexView as VVIndex

urlpatterns = [
    url(r'^set_cart/$', SetCart.as_view(), name="set-cart"),
    url(r'^customer/$', CustomerFormView.as_view(), name="customer-form"),
